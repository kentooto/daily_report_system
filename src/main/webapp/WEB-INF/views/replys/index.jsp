    ...
    <c:param name="content">
        ...
        <table id="reply_list">
            <tbody>
                ...
                <c:forEach var="reply" items="${reports}" varStatus="status">
                    ...
                    <tr class="row${status.count % 2}">
                        ...
                        <td class="reply_title">${report.title}</td>
                        <td class="reply_action"><a href="<c:url value='?action=${actRepl}&command=${commShow}&id=${reply.id}' />">詳細を見る</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
